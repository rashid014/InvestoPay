...
import Front from '../../img/Front3.jpg'
...
const Form = () => {
  ...
  return (
    ...
    <div className="flex flex-wrap items-center justify-center mt-0 bg-white">

    <Card title="" style={{ width: 700, backgroundColor: '#fff' }}>
          <img
            src={Front}
  ...
  <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8 flex-1">
    ...
    <div className="mx-auto max-w-2xl text-center">
      ...
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        ...
        <div className="mt-10">
          <button type="submit" className="block w-full rounded-md bg-blue-900 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Let's talk</button>
        </div>
      </form>
      </div>
